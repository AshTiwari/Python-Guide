...
def GreaterThanBinarySearch(array, element):
	input =  binarySearch(array,element, 2)
	if isinstance(input, int):
		return input 
	elif isinstance(input, tuple):
...
if __name__ == "__main__":
	...
	#print(leastIndexBinarySearch(array,element))
	#print(BinarySearchWithFrequency(array,element))
	print(lessThanBinarySearch(array,element))
	print(GreaterThanBinarySearch(array,element))
